...
create_clock -period 10.000 -name sys_clk_pin -waveform {0.000 5.000} -add [get_ports ap_clk]
...
## LEDs
set_property PACKAGE_PIN U16 [get_ports {out_V}]
set_property IOSTANDARD LVCMOS33 [get_ports {out_V}]
#set_property IOSTANDARD LVCMOS33 [get_ports {out_V[6]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {out_V[5]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {out_V[4]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {out_V[3]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {out_V[2]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {out_V[1]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {out_V[0]}]
set_property PACKAGE_PIN E19 [get_ports {out_add}]
set_property IOSTANDARD LVCMOS33 [get_ports {out_add}]
#set_property IOSTANDARD LVCMOS33 [get_ports {out_add[3]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {out_add[2]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {out_add[1]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {out_add[0]}]
...
create_pblock pblock_multiply
add_cells_to_pblock [get_pblocks pblock_multiply] [get_cells -quiet [list multiply]]
resize_pblock [get_pblocks pblock_multiply] -add {SLICE_X40Y51:SLICE_X43Y99}
